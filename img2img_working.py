...
def generate_image_with_smart_loras(prompt: str, num_inference_steps: int = 4):
    """
...
async def generate_image(
    ...
    try:
        ...
        image, used_loras, final_prompt = generate_image_with_smart_loras(prompt, num_inference_steps)
...
import nest_asyncio
!ngrok authtoken 2xNBjsJZTEMSyZIjuYEAxPqFauzLBSHA8EJv
