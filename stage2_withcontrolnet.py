...
"""
this version only works with control image and control net , without , it will give error
"""
...
print("pipe tensor device: %s", pipe.device)
...
def generate_image_sync(prompt, height, width, num_inference_steps, guidance_scale,control_image_pil):
  try:
